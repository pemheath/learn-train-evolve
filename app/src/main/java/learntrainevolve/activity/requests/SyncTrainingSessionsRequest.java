...
public class SyncTrainingSessionsRequest {
    ...
    public SyncTrainingSessionsRequest(String email, String eventId, long timeAndDate,
    ...
    public static class Builder {
        ...
        public SyncTrainingSessionsRequest build() {
            ...
            SyncTrainingSessionsRequest request = new SyncTrainingSessionsRequest(email, eventId, timeAndDate, type, coach,  intensityRating,
